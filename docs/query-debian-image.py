...
OUTPUT_README = "../src/debian/readme.md"
IMAGE_URI = "public.ecr.aws/dev1-sg/base/debian:latest"
...
def main():
    ...
    local_output_str = run_container_command(client, image_name, "ls -l /usr/local/bin", arch)
